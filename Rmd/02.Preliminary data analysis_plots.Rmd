...
<!-- ## 2.How does activation and exhaustion marker correlate with plasma cell presence? -->
...
<!--        baseline_ferritin_cat = "Baseline ferritin, < 400 vs. ≥ 400", -->
<!--        baseline_crp_cat = "Baseline CRP, < 0.5 vs. ≥ 0.5", inpatientbed = "Inpatient bed days", -->
...
<!--          baseline_crp, baseline_crp_cat, baseline_ferritin, baseline_ferritin_cat, baseline_b2m, baseline_B2M, ldh_pre_infusion, -->
...
<!-- # III.Correlation plasma cell vs clinical -->
<!-- ```{r} -->
...
# IV.Explore immune cells in the context of clinical
## 1.by gr2_CRS
...
```{r}
A1 <- immune_data %>% 
  filter(!is.na(gr2_CRS)) %>% 
  ggplot(aes(x = gr2_CRS, y = percent_cd3plus_cd8plus))+
  geom_boxplot()+
  labs(x = "CRS grade (<2 vs. ≥2)", y = "CD3+CD8+ (%)")+
...
immune_data %>% 
  filter(!is.na(gr2_CRS)) %>% 
  ggplot(aes(x = gr2_CRS, y = cd3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "CRS grade (<2 vs. ≥2)", y = "CD3+TIM3+/CD3+")
A2 <- immune_data %>% 
  filter(!is.na(gr2_CRS)) %>% 
  ggplot(aes(x = gr2_CRS, y = cd3plus_pd1plus_lag3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "CRS grade (<2 vs. ≥2)", y = "CD3+PD1+LAG3+/CD3+")+
  stat_compare_means()
A2
```
</div>
...
C2 <- immune_data %>% 
  filter(!is.na(gr2_CRS)) %>% 
  ggplot(aes(x = gr2_CRS, y = cd3plus_pd1plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "CRS grade (<2 vs. ≥2)", y = "CD3+PD1+TIM3+/CD3+")+
  stat_compare_means()
C2
E2 <- immune_data %>% 
  filter(!is.na(gr2_CRS)) %>% 
  ggplot(aes(x = gr2_CRS, y = cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "CRS grade (<2 vs. ≥2)", y = "CD3+PD1+LAG3+TIM3+/CD3+")+
  stat_compare_means()
E2
```
</div>
...
```{r}
B1 <- immune_data %>% 
  filter(!is.na(gr2_ICANS)) %>% 
  ggplot(aes(x = gr2_ICANS, y = percent_cd3plus_cd8plus))+
  geom_boxplot()+
  labs(x = "ICANS grade (<2 vs. ≥2)", y = "CD3+CD8+ (%)")+
  stat_compare_means()
B1
immune_data %>% 
  filter(!is.na(gr2_ICANS)) %>% 
  ggplot(aes(x = gr2_ICANS, y = cd3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "ICANS grade (<2 vs. ≥2)", y = "CD3+TIM3+/CD3+")
immune_data %>% 
  filter(!is.na(gr2_ICANS)) %>% 
  ggplot(aes(x = gr2_ICANS, y = cd3plus_pd1plus_lag3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "ICANS grade (<2 vs. ≥2)", y = "CD3+PD1+LAG3+/CD3+")
```
</div>
...
immune_data %>% 
  filter(!is.na(gr2_ICANS)) %>% 
  ggplot(aes(x = gr2_ICANS, y = cd3plus_pd1plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "ICANS grade (<2 vs. ≥2)", y = "CD3+PD1+TIM3+/CD3+")
immune_data %>% 
  filter(!is.na(gr2_ICANS)) %>% 
  ggplot(aes(x = gr2_ICANS, y = cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "ICANS grade (<2 vs. ≥2)", y = "CD3+PD1+LAG3+TIM3+/CD3+")
```
</div>
</div>
...
```{r}
C1 <- immune_data %>% 
  filter(!is.na(ORR_30days)) %>% 
  ggplot(aes(x = ORR_30days, y = percent_cd3plus_cd8plus))+
  geom_boxplot()+
  labs(x = "Day 30 ORR", y = "CD3+CD8+ (%)")+
  stat_compare_means()
C1
immune_data %>% 
  filter(!is.na(ORR_30days)) %>% 
  ggplot(aes(x = ORR_30days, y = cd3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Day 30 ORR", y = "CD3+TIM3+/CD3+")
immune_data %>% 
  filter(!is.na(ORR_30days)) %>% 
  ggplot(aes(x = ORR_30days, y = cd3plus_pd1plus_lag3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Day 30 ORR", y = "CD3+PD1+LAG3+/CD3+")
```
</div>
...
immune_data %>% 
  filter(!is.na(ORR_30days)) %>% 
  ggplot(aes(x = ORR_30days, y = cd3plus_pd1plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Day 30 ORR", y = "CD3+PD1+TIM3+/CD3+")
immune_data %>% 
  filter(!is.na(ORR_30days)) %>% 
  ggplot(aes(x = ORR_30days, y = cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Day 30 ORR", y = "CD3+PD1+LAG3+TIM3+/CD3+")
```
</div>
</div>
...
```{r}
D1 <- immune_data %>% 
  filter(!is.na(best_ORR)) %>% 
  ggplot(aes(x = best_ORR, y = percent_cd3plus_cd8plus))+
  geom_boxplot()+
  labs(x = "Best ORR", y = "CD3+CD8+ (%)")+
  stat_compare_means()
D1
immune_data %>% 
  filter(!is.na(best_ORR)) %>% 
  ggplot(aes(x = best_ORR, y = cd3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Best ORR", y = "CD3+TIM3+/CD3+")
B2 <- immune_data %>% 
  filter(!is.na(best_ORR)) %>% 
  ggplot(aes(x = best_ORR, y = cd3plus_pd1plus_lag3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Best ORR", y = "CD3+PD1+LAG3+/CD3+")+
  stat_compare_means()
B2
```
</div>
...
D2 <- immune_data %>% 
  filter(!is.na(best_ORR)) %>% 
  ggplot(aes(x = best_ORR, y = cd3plus_pd1plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Best ORR", y = "CD3+PD1+TIM3+/CD3+")+
  stat_compare_means()
D2
F2 <- immune_data %>% 
  filter(!is.na(best_ORR)) %>% 
  ggplot(aes(x = best_ORR, y = cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio))+
  geom_boxplot()+
  labs(x = "Best ORR", y = "CD3+PD1+LAG3+TIM3+/CD3+")+
  stat_compare_means()
F2
```
</div>
...
immune_data %>% 
  select("CRS grade (<2 vs. ≥2)" = gr2_CRS, 
         "ICANS grade (<2 vs. ≥2)" = gr2_ICANS, 
         "Day 30 ORR" = ORR_30days, 
         "Best ORR" = best_ORR,
         percent_cd3plus_cd8plus) %>% 
  pivot_longer(cols = -percent_cd3plus_cd8plus) %>% 
  mutate(name = factor(name, levels = c("CRS grade (<2 vs. ≥2)", "ICANS grade (<2 vs. ≥2)", 
                                        "Day 30 ORR", "Best ORR"))
         ) %>% 
  ggplot(aes(x = value, y = percent_cd3plus_cd8plus, group= value))+
  geom_boxplot()+
  labs(x = NULL, y = "CD3+CD8+ (%)")+
  facet_grid(. ~ name, scales = "free")+
  ylim(0, 12.5)+
  scale_y_break(breaks = c(7, 11), 
                ticklabels=c(12))+ 
...
```{r}
# immune_data %>% 
#   select("CRS grade (<2 vs. ≥2)" = gr2_CRS, "Best ORR" = best_ORR,
#          "CD3+PD1+LAG3+/CD3+" = cd3plus_pd1plus_lag3plus.CD3ratio,
#          "CD3+PD1+TIM3+/CD3+" = cd3plus_pd1plus_tim3plus.CD3ratio,
#          "CD3+PD1+LAG3+TIM3+/CD3+" = cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio
#          ) %>% 
#   pivot_longer(cols = c(`CRS grade (<2 vs. ≥2)`, `Best ORR`), 
#                values_to = "group",
#                names_to = "response") %>% 
#   mutate(response = factor(response, levels = c("CRS grade (<2 vs. ≥2)", "Best ORR"))
#          ) %>% 
#   pivot_longer(cols = -c(response, group),
...
immune_data %>% 
  ...
  pivot_longer(cols = -c("CRS grade (<2 vs. ≥2)")) %>% 
  filter(!is.na(value)) %>% 
  ggplot(aes(x = `CRS grade (<2 vs. ≥2)`, y = value))+
  geom_boxplot()+
  labs(x = "CRS grade (<2 vs. ≥2)", y = NULL)+
  scale_y_log10()+
...
immune_data %>% 
  select("Best ORR" = best_ORR,
         "CD3+PD1+LAG3+/CD3+" = cd3plus_pd1plus_lag3plus.CD3ratio,
         "CD3+PD1+TIM3+/CD3+" = cd3plus_pd1plus_tim3plus.CD3ratio,
         "CD3+PD1+LAG3+TIM3+/CD3+" = cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio
         ) %>% 
  pivot_longer(cols = -c("Best ORR")) %>% 
  filter(!is.na(value)) %>% 
  ggplot(aes(x = `Best ORR`, y = value))+
  geom_boxplot()+
  labs(x = "Best ORR", y = NULL)+
  scale_y_log10()+
  # facet_grid(cols = vars(name)#,
  #            # scales = "free"
  #            )
...
<!-- # V.Immune cell in CART treatment context -->
...
<!-- # VI.Immune cell in CART response -->
...
<!-- # VIII.Progression free survival -->
<!-- ## 1.HR -->
<!-- ```{r} -->
<!-- tbl_uni <- immune_data %>%  -->
...
<!-- # IX.Subsetting marrow burden -->
<!-- ```{r high marrow subset} -->
<!-- high_marrow_subset <- immune_data %>%  -->
<!--   filter(!is.na(high_marrow_burden_50_percent)) -->
<!-- marrow_Yes <- high_marrow_subset %>%  -->
<!--   filter(high_marrow_burden_50_percent == "Yes") -->
<!-- marrow_No <- high_marrow_subset %>%  -->
<!--   filter(high_marrow_burden_50_percent == "No") -->
<!-- ``` -->

<!-- ## 1.Table by marrow burden -->
<!-- ```{r} -->
<!-- high_marrow_subset %>%  -->
<!--   select(gr2_CRS, gr2_ICANS, ORR_30days, best_ORR, -->
<!--          high_marrow_burden_50_percent) %>%  -->
<!--   tbl_summary(by= high_marrow_burden_50_percent) %>%  -->
<!--   bold_labels() %>% -->
<!--   add_p() %>% bold_p(t= 0.05) %>% -->
<!--   modify_spanning_header(everything() ~ "Marrow burden (50%)") -->
<!-- ``` -->

<!-- ## 2.Stratified analyses - cell type vs tox/response by marrow burden -->
<!-- ```{r} -->
<!-- tbl1 <- marrow_Yes %>%  -->
<!--   select(gr2_CRS, cd3plus_cd8plus_cat, -->
<!--          cd3plus_tim3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio_cat, -->
...
<!--   bold_labels() %>% -->
<!--   add_p() %>% bold_p(t= 0.05) -->
<!-- tbl_merge(list(tbl1, tbl2), tab_spanner = c("High marrow", "Low marrow")) %>% -->
<!--   modify_caption("**CRS grade (<2 vs. ≥2)** (N = {N})") -->

<!-- tbl1 <- marrow_Yes %>%  -->
<!--   select(gr2_ICANS, cd3plus_cd8plus_cat, -->
<!--          cd3plus_tim3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio_cat, -->
...
<!--   add_p() %>% bold_p(t= 0.05) -->
<!-- tbl_merge(list(tbl1, tbl2), tab_spanner = c("High marrow", "Low marrow")) %>% -->
<!--   modify_caption("**ICANS grade (<2 vs. ≥2)** (N = {N})") -->

<!-- tbl1 <- marrow_Yes %>%  -->
<!--   select(ORR_30days, cd3plus_cd8plus_cat, -->
<!--          cd3plus_tim3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio_cat, -->
...
<!--   add_p() %>% bold_p(t= 0.05) -->
<!-- tbl_merge(list(tbl1, tbl2), tab_spanner = c("High marrow", "Low marrow")) %>% -->
<!--   modify_caption("**Day 30 ORR** (N = {N})") -->

<!-- tbl1 <- marrow_Yes %>%  -->
<!--   select(best_ORR, cd3plus_cd8plus_cat, -->
<!--          cd3plus_tim3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus.CD3ratio_cat, -->
<!--          cd3plus_pd1plus_lag3plus_tim3plus.CD3ratio_cat, -->
...
<!--          ) %>% -->
<!--   tbl_uvregression(method = survival::coxph, -->
<!--                    y = (Surv(time = marrow_Yes$mo_os_from_infusion, -->
<!--                              event = marrow_Yes$os_event)), -->
<!--                    exponentiate = TRUE) %>% -->
<!--   bold_labels() %>% italicize_levels() %>% -->
<!--   bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>% -->
<!--   modify_spanning_header(everything() ~ "Yes - Marrow burden (50%)") -->
<!-- ``` -->
...
<!--          ) %>% -->
<!--   tbl_uvregression(method = survival::coxph, -->
<!--                    y = (Surv(time = marrow_No$mo_os_from_infusion, -->
<!--                              event = marrow_No$os_event)), -->
<!--                    exponentiate = TRUE) %>% -->
<!--   bold_labels() %>% italicize_levels() %>% -->
<!--   bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") %>% -->
<!--   modify_spanning_header(everything() ~ "No - Marrow burden (50%)") -->
<!-- ``` -->
...
<!-- <!-- ### Logistic regression --> -->
<!-- <!-- ```{r} --> -->
<!-- <!-- immune_data_lm <- high_marrow_subset %>% --> -->
<!-- <!--   mutate(gr2_CRS = case_when( --> -->
<!-- <!--     gr2_CRS == "Grade <2"    ~ 0, --> -->
<!-- <!--     gr2_CRS == "Grade ≥2"   ~ 1 --> -->
<!-- <!--   )) --> -->

<!-- <!-- marrow_Yes <- immune_data_lm %>%  --> -->
<!-- <!--   filter(high_marrow_burden_50_percent == "Yes") --> -->
<!-- <!-- marrow_No <- immune_data_lm %>%  --> -->
<!-- <!--   filter(high_marrow_burden_50_percent == "No") --> -->
<!-- <!-- ``` --> -->
